...
var table = (function () {
  ...
  var createStyleForm = function (editor) {
    ...
    return {
      ...
      items: [
        // WINTERNET-STUDIO CUSTOMIZATION: Changed type from "textbox" to "spacer" and changed label from "Style" to "" in order to deactivate it. Outcommenting the whole thing will break using other styling fields.
        {
          label: '',
          name: 'style',
          type: 'spacer'
          ...
          items: [
            {
              ...
              values: [
                // WINTERNET-STUDIO CUSTOMIZATION: Remove all but the "Solid" option. Currently we only support that.
                // {
                //   text: 'Select...',
                //   value: ''
                // },
